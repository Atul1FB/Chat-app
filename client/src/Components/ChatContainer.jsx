...
function ChatContainer() {
  ...
  return selectedUser ? (
          ...
          return (
            ...
            >
              {msg.image ? (
                ...
                <p
                  className={`p-2 max-w-[220px] text-sm font-light rounded-lg mb-8 break-words bg-violet-500/30 text-white ${
    ...
    <div className="flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden rounded-xl">
      <img src={assets.logo_icon} alt="logo" className="max-w-6 pt-2" />
